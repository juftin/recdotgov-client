...
import recdotgov_client.models
from recdotgov_client import rest
...
class ApiClient(object):
    ...
    def __init__(
        ...
        self.user_agent = "Swagger-Codegen/${PROJECT_VERSION}/python"
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(recdotgov_client.models, klass)
