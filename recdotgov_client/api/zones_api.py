...
class ZonesApi(object):
    ...
    def get_permit_entrance_zone(self, zone_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.get_permit_entrance_zone_with_http_info(zone_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_permit_entrance_zone_with_http_info(zone_id, **kwargs)  # noqa: E501
            return data
    ...
    def get_permit_entrance_zone_with_http_info(self, zone_id, **kwargs):  # noqa: E501
        ...
        if ('zone_id' not in params or
            ...
            raise ValueError("Missing the required parameter `zone_id` when calling `get_permit_entrance_zone`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/permitentrances/{permitEntranceId}/zones/{zoneId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_permit_entrance_zones(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_permit_entrance_zones_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def get_permit_entrance_zones_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/permitentrances/{permitEntranceId}/zones', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
