...
class CampsitesApi(object):
    ...
    def get_campsites(self, **kwargs):  # noqa: E501
        """Retrieve all campsites  # noqa: E501

        This endpoint retrieves all campsites  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_campsites(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str query: Query filter criteria. Searches on campsite name, type, loop, type of use (Overnight/Day), campsite accessible (Yes/No)
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_campsites_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_campsites_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_campsites_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieve all campsites  # noqa: E501

        This endpoint retrieves all campsites  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_campsites_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def get_facility_campsite(self, facility_id, campsite_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_facility_campsite(facility_id, campsite_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_facility_campsite_with_http_info(
                facility_id, campsite_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_facility_campsite_with_http_info(
                facility_id, campsite_id, **kwargs
            )  # noqa: E501
            return data

    def get_facility_campsite_with_http_info(
        self, facility_id, campsite_id, **kwargs
    ):  # noqa: E501
        """Retrieve a specific campsite by id for a facility  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_facility_campsite_with_http_info(facility_id, campsite_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ["facility_id", "campsite_id"]  # noqa: E501
        all_params.append("async_req")
        all_params.append("_return_http_data_only")
        all_params.append("_preload_content")
        all_params.append("_request_timeout")
        ...
        if "facility_id" not in params or params["facility_id"] is None:
            raise ValueError(
                "Missing the required parameter `facility_id` when calling `get_facility_campsite`"
            )  # noqa: E501
        # verify the required parameter 'campsite_id' is set
        if "campsite_id" not in params or params["campsite_id"] is None:
            raise ValueError(
                "Missing the required parameter `campsite_id` when calling `get_facility_campsite`"
            )  # noqa: E501
    ...
    def get_facility_campsites(self, facility_id, **kwargs):  # noqa: E501
        """Retrieve all campsites for a facility  # noqa: E501

        This endpoint retrieves all campsites for a specific facility.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_facility_campsites(facility_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_facility_campsites_with_http_info(
                facility_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_facility_campsites_with_http_info(
                facility_id, **kwargs
            )  # noqa: E501
            return data

    def get_facility_campsites_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_facility_campsites_with_http_info(facility_id, async_req=True)
        >>> result = thread.get()
        ...
        if "facility_id" not in params or params["facility_id"] is None:
            raise ValueError(
                "Missing the required parameter `facility_id` when calling `get_facility_campsites`"
            )  # noqa: E501
