...
class Activity(object):
    ...
    def __init__(self, activity_id=None, activity_parent_id=None, activity_name=None, activity_level=None):  # noqa: E501
    ...
    def activity_level(self, activity_level):
        ...
        if activity_level is None:
            raise ValueError("Invalid value for `activity_level`, must not be `None`")  # noqa: E501
