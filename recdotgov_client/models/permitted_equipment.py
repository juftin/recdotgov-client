...
class PermittedEquipment(object):
    ...
    """
    swagger_types = {"equipment_name": "str", "max_length": "float"}

    attribute_map = {"equipment_name": "EquipmentName", "max_length": "MaxLength"}
    ...
    def equipment_name(self, equipment_name):
        ...
        if equipment_name is None:
            raise ValueError(
                "Invalid value for `equipment_name`, must not be `None`"
            )  # noqa: E501
    ...
    def max_length(self, max_length):
        ...
        if max_length is None:
            raise ValueError(
                "Invalid value for `max_length`, must not be `None`"
            )  # noqa: E501
