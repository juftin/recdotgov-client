...
class Link(object):
    ...
    def __init__(self, entity_link_id=None, link_type=None, entity_id=None, entity_type=None, title=None, description=None, url=None):  # noqa: E501
    ...
    def entity_link_id(self, entity_link_id):
        ...
        if entity_link_id is None:
            raise ValueError("Invalid value for `entity_link_id`, must not be `None`")  # noqa: E501
