...
class PermitEntrance(object):
    ...
    def __init__(self, permit_entrance_id=None, facility_id=None, permit_entrance_name=None, permit_entrance_description=None, district=None, town=None, permit_entrance_accessible=None, longitude=None, latitude=None, attributes=None, entitymedia=None, zones=None):  # noqa: E501
    ...
    def permit_entrance_description(self, permit_entrance_description):
        ...
        if permit_entrance_description is None:
            raise ValueError("Invalid value for `permit_entrance_description`, must not be `None`")  # noqa: E501
    ...
    def permit_entrance_accessible(self, permit_entrance_accessible):
        ...
        if permit_entrance_accessible is None:
            raise ValueError("Invalid value for `permit_entrance_accessible`, must not be `None`")  # noqa: E501
