...
class RecreationArea(object):
    ...
    def __init__(self, rec_area_id=None, org_rec_area_id=None, parent_org_id=None, rec_area_name=None, rec_area_description=None, rec_area_fee_description=None, rec_area_directions=None, rec_area_phone=None, rec_area_email=None, rec_area_reservation_url=None, rec_area_map_url=None, geojson=None, rec_area_longitude=None, rec_area_latitude=None, stay_limit=None, keywords=None, reservable=None, enabled=None, organization=None, facility=None, recareaaddress=None, activity=None, event=None, media=None, link=None):  # noqa: E501
    ...
    def org_rec_area_id(self, org_rec_area_id):
        ...
        if org_rec_area_id is None:
            raise ValueError("Invalid value for `org_rec_area_id`, must not be `None`")  # noqa: E501
    ...
    def rec_area_description(self, rec_area_description):
        ...
        if rec_area_description is None:
            raise ValueError("Invalid value for `rec_area_description`, must not be `None`")  # noqa: E501
    ...
    def rec_area_fee_description(self, rec_area_fee_description):
        ...
        if rec_area_fee_description is None:
            raise ValueError("Invalid value for `rec_area_fee_description`, must not be `None`")  # noqa: E501
    ...
    def rec_area_directions(self, rec_area_directions):
        ...
        if rec_area_directions is None:
            raise ValueError("Invalid value for `rec_area_directions`, must not be `None`")  # noqa: E501
    ...
    def rec_area_phone(self, rec_area_phone):
        ...
        if rec_area_phone is None:
            raise ValueError("Invalid value for `rec_area_phone`, must not be `None`")  # noqa: E501
    ...
    def rec_area_email(self, rec_area_email):
        ...
        if rec_area_email is None:
            raise ValueError("Invalid value for `rec_area_email`, must not be `None`")  # noqa: E501
    ...
    def rec_area_reservation_url(self, rec_area_reservation_url):
        ...
        if rec_area_reservation_url is None:
            raise ValueError("Invalid value for `rec_area_reservation_url`, must not be `None`")  # noqa: E501
    ...
    def rec_area_map_url(self, rec_area_map_url):
        ...
        if rec_area_map_url is None:
            raise ValueError("Invalid value for `rec_area_map_url`, must not be `None`")  # noqa: E501
    ...
    def rec_area_longitude(self, rec_area_longitude):
        ...
        if rec_area_longitude is None:
            raise ValueError("Invalid value for `rec_area_longitude`, must not be `None`")  # noqa: E501
    ...
    def rec_area_latitude(self, rec_area_latitude):
        ...
        if rec_area_latitude is None:
            raise ValueError("Invalid value for `rec_area_latitude`, must not be `None`")  # noqa: E501
