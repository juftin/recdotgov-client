...
class RecreationAreaActivity(object):
    ...
    def __init__(
        ...
        rec_area_id=None,
        activity_name=None,
        rec_area_activity_description=None,
        rec_area_activity_fee_description=None,
    ):  # noqa: E501
    ...
    def rec_area_activity_description(self, rec_area_activity_description):
        ...
        if rec_area_activity_description is None:
            raise ValueError(
                "Invalid value for `rec_area_activity_description`, must not be `None`"
            )  # noqa: E501
    ...
    def rec_area_activity_fee_description(self, rec_area_activity_fee_description):
        ...
        if rec_area_activity_fee_description is None:
            raise ValueError(
                "Invalid value for `rec_area_activity_fee_description`, must not be `None`"
            )  # noqa: E501
