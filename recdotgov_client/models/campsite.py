...
class Campsite(object):
    ...
    def __init__(self, campsite_id=None, facility_id=None, campsite_name=None, campsite_type=None, type_of_use=None, loop=None, campsite_accessible=None, campsite_longitude=None, campsite_latitude=None, created_date=None, last_updated_date=None, attributes=None, permittedequipment=None, entitymedia=None):  # noqa: E501
    ...
    def campsite_type(self, campsite_type):
        ...
        if campsite_type is None:
            raise ValueError("Invalid value for `campsite_type`, must not be `None`")  # noqa: E501
    ...
    def type_of_use(self, type_of_use):
        ...
        if type_of_use is None:
            raise ValueError("Invalid value for `type_of_use`, must not be `None`")  # noqa: E501
    ...
    def loop(self, loop):
        ...
        """
        if loop is None:
            raise ValueError("Invalid value for `loop`, must not be `None`")  # noqa: E501
    ...
    def campsite_accessible(self, campsite_accessible):
        ...
        if campsite_accessible is None:
            raise ValueError("Invalid value for `campsite_accessible`, must not be `None`")  # noqa: E501
    ...
    def permittedequipment(self, permittedequipment):
        ...
        if permittedequipment is None:
            raise ValueError("Invalid value for `permittedequipment`, must not be `None`")  # noqa: E501
