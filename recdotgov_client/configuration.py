...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self):
        """Constructor"""
        # Default Base url
        self.host = "https://ridb.recreation.gov/api/v1"
        ...
        # Logging Settings
        self.logger = {}
        self.logger["package_logger"] = logging.getLogger("recdotgov_client")
    ...
    def to_debug_report(self):
        ...
        return (
            ...
            "SDK Package Version: 0.1.9".format(env=sys.platform, pyversion=sys.version)
        )
